...
export const CAPABILITY_CATALOG: readonly CapabilityDefinition[] = [
	...
	},
	{
		...
		description: 'Crear, cambiar o cancelar turnos.',
		kind: 'ACTION',
		sortOrder: 21,
	},
	{
		...
		groupLabel: 'Clientes',
		label: 'Ver clientes',
		description: 'Ver el listado y la ficha de cada cliente. El profesional solo ve los suyos.',
		kind: 'MENU',
		sortOrder: 30,
	},
	{
		...
		description: 'Agregar clientes nuevos.',
		kind: 'ACTION',
		sortOrder: 31,
	},
	{
	...
	},
	{
		...
		description: 'Descargar el listado de clientes.',
		kind: 'ACTION',
		sortOrder: 33,
	},
	{
		...
		groupLabel: 'Cobros',
		label: 'Ver cobros',
		description: 'Ver señas y reembolsos.',
		kind: 'MENU',
		sortOrder: 40,
	},
	{
		...
		description: 'Aprobar o rechazar señas y reembolsos.',
		kind: 'ACTION',
		sortOrder: 41,
	},
	{
		...
		label: 'Ver servicios',
		description: 'Ver los servicios que ofrece el negocio.',
		kind: 'MENU',
		sortOrder: 50,
	},
	{
		...
		description: 'Agregar, cambiar o quitar servicios.',
		kind: 'ACTION',
		sortOrder: 51,
	},
	{
		...
		description: 'Ver las sucursales, sin poder cambiarlas.',
		kind: 'MENU',
		sortOrder: 60,
	},
	{
		...
		description: 'Crear o editar sucursales y marcar días de cierre.',
		kind: 'ACTION',
		sortOrder: 61,
	},
	{
		...
		description: 'Editar el logo, los textos y la página que ven los clientes.',
		kind: 'MENU',
		sortOrder: 70,
	},
	{
		...
		description: 'Ver los complementos que se pueden sumar al negocio.',
		kind: 'MENU',
		sortOrder: 80,
	},
	{
		...
		description: 'Contratar o dar de baja complementos del negocio.',
		kind: 'ACTION',
		sortOrder: 81,
	},
	{
		...
		description: 'Usar el odontograma. Hace falta tener el complemento.',
		kind: 'ADDON',
		sortOrder: 82,
	...
	},
	{
		...
		description: 'Usar el mapa corporal. Hace falta tener el complemento.',
		kind: 'ADDON',
		sortOrder: 83,
	...
	},
	{
		...
		description: 'Ver las especialidades del equipo.',
		kind: 'MENU',
		sortOrder: 90,
	},
	{
		...
		description: 'Agregar o cambiar especialidades.',
		kind: 'ACTION',
		sortOrder: 91,
	},
	{
		...
		groupLabel: 'Personal',
		label: 'Ver personal',
		description: 'Ver al equipo y las invitaciones pendientes.',
		kind: 'MENU',
		sortOrder: 100,
	},
	{
		...
		description: 'Invitar gente, cambiar roles y decidir quién aparece en la página pública.',
		kind: 'ACTION',
		sortOrder: 101,
	},
	{
		...
		groupLabel: 'Horarios',
		label: 'Ver horarios',
		description: 'Ver horarios y días especiales.',
		kind: 'MENU',
		sortOrder: 110,
	},
	{
	...
	},
	{
		...
		groupLabel: 'Ajustes',
		label: 'Ver ajustes',
		description: 'Abrir Ajustes de tu perfil y tu contraseña.',
		kind: 'MENU',
		sortOrder: 120,
	},
	{
	...
	},
	{
		...
		groupLabel: 'Plan',
		label: 'Ver plan',
		description: 'Ver el plan contratado y las facturas del negocio.',
		kind: 'MENU',
		sortOrder: 130,
	},
	{
		...
		description: 'Cambiar de plan, pagar y elegir cómo cobrás.',
		kind: 'ACTION',
		sortOrder: 131,
	},
	{
		...
		description: 'Elegir qué puede ver y hacer cada rol. En Admin no se puede apagar.',
		kind: 'ACTION',
		sortOrder: 140,
		lockedForRoles: [A],
	},
