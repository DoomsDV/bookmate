...
test('la mascota y el BFF quedan desacoplados de ATC', () => {
	...
	assert.ok(existsSync(new URL('../public/assistant/auri-reading-mobile-body.png', import.meta.url)));
	assert.ok(existsSync(new URL('../public/assistant/auri-tail-layer.png', import.meta.url)));
	...
	assert.match(mascot, /auri-reading-mobile-body\.png/);
	assert.match(mascot, /auri-tail-layer\.png/);
	assert.match(mascot, /data-tail-layer/);
	assert.match(mascot, /data-tail-body/);
	assert.match(mascot, /auri-tail-swing/);
	assert.doesNotMatch(mascot, /assistant-mascot__hook/);
	assert.doesNotMatch(mascot, /auri-tail-sway/);
